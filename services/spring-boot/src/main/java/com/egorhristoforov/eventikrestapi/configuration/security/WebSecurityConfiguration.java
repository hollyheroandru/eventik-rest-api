    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("/api/v1/events/**/visitors/**").authenticated()
                    .antMatchers("/api/v1/events/**/visitors/**").hasAnyRole("ADMIN", "MODERATOR")
                    .antMatchers(HttpMethod.GET, "/api/v1/events/**/chat").authenticated()
                    .antMatchers("/api/v1/events/**/chat").authenticated()
                    .antMatchers("/api/v1/events/**/chat").hasAnyRole("ADMIN", "MODERATOR")
                    .antMatchers(HttpMethod.GET, "/api/v1/events/**/news").authenticated()
                    .antMatchers("/api/v1/events/**/news/**").authenticated()
                    .antMatchers("/api/v1/events/**/news/**").hasAnyRole("ADMIN", "MODERATOR")
